export const AppConfig = {
    ...
    getNonPaidAllocationsWithAllocationType: 'getNonPaidAllocationsWithAllocationType',
    ...
    getAllocationCountForPartnerConsultant: 'getAllocationCountForPartnerConsultant',
...
export const OAUTH_CONFIG = {
    SKIP_TOKEN_EXCHANGE: process.env.REACT_APP_SKIP_TOKEN_EXCHANGE === "true" ? true : false,
