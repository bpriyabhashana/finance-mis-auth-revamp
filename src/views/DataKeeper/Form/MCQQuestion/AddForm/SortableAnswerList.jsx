      ...
      <Row className="noselect">
        <Col sm={2}>
          <ButtonGroup minimal={true}>
            ...
            <Button
              disabled={index + 1 > this.props.answerLength}
            ...
            <ButtonGroup minimal={true}>
              {this.state.editIndex === index && (
                <Button
                  icon="floppy-disk"
                  onClick={() => {
                    this.ChangeAnswerState(index, 3, Temp_EditedAnswer);
                    this.ChangeAnswerState(index, 5);
                  }}
                />
              )}
              {this.state.editIndex === index && <Divider />}
              <Button
                icon={this.state.editIndex === index ? "cross" : "edit"}
                intent={this.state.editIndex === index ? "danger" : ""}
